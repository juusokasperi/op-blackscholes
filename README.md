...
- Γ_cs_45: This method shows a much wider and deeper "U-shape." It is accurate for a very broad range of h values. The "sweet spot" is clear, with a minimum error around hrel​≈10^-8.
...
# Recommendation
- For calculating Delta (Δ): Use the complex-step method (Δ_cs). Step size like hrel 10^-11 is good.
